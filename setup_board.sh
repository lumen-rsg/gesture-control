...
echo "=== Ethernet setup: Single Board Computer ==="
...
if ping -c 3 -W 1 192.168.50.1 >/dev/null 2>&1; then
    echo "OK: PC is reachable."
else
    echo "WARNING: PC is not reachable."
    echo "Check Ethernet cable and PC configuration."
fi
